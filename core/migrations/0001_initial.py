# Generated by Django 5.2 on 2026-01-13 04:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('superadmin', 'Superadmin'), ('tenant_admin', 'Tenant Admin'), ('tenant_editor', 'Tenant Editor'), ('web_user', 'Web User')], max_length=20)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('info', 'Informative'), ('portfolio', 'Portafolio'), ('ecommerce', 'Ecommerce')], max_length=20)),
                ('name', models.CharField(max_length=100)),
                ('is_active', models.BooleanField(default=True)),
